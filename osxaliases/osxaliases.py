...
def is_alias(path):
    ...
    print(
        "is_alias: ERROR subprocess returned unexpected response:"
        + str(code)
        + " -- "
        + str(out)
        + " -- "
...
def create_osx_alias(filename, aliasname):
    ...
    print(
        "create_osx_alias: ERROR subprocess returned unexpected response: "
        + str(code)
        + " -- "
        + str(out)
        + " -- "
...
def resolve_osx_alias(path):
    ...
    if code != 0:
        print(
            "resolve_osx_alias: ERROR subprocess returned unexpected response: "
            + str(code)
            + " -- "
            + str(out)
            + " -- "
